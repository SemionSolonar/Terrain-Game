...
public class DinosaurWalking : StateMachineBehaviour
{
    float timer;
    List<Transform> WayPointsDz = new List<Transform>();
    NavMeshAgent agent;
    Transform player;
    Animator animator;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        timer = 0;
        GameObject go = GameObject.FindGameObjectWithTag("WayPointsDz");
        ...
        agent.SetDestination(WayPointsDz[Random.Range(0, WayPointsDz.Count)].position);
    }
